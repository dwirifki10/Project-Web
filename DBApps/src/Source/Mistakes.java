 ...
 */
public class Mistakes extends javax.swing.JFrame {
int dragxmouse, dragymouse;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TIDAK BOLEH ADA FIELD KOSONG");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mistakes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
