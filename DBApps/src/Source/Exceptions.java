 ...
 */
public class Exceptions extends javax.swing.JFrame {
int dragxmouse, dragymouse;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("KODE YANG DIMASUKAN SUDAH ADA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exceptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exceptions().setVisible(true);
            }
        });
    }
