 ...
 */
public class Exceptions2 extends javax.swing.JFrame {
int dragxmouse, dragymouse;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NISN ATAU NIS YANG DIMASUKAN SUDAH ADA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exceptions2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exceptions2().setVisible(true);
            }
        });
    }
