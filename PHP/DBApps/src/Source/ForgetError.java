 ...
 */
public class ForgetError extends javax.swing.JFrame {
int dragxmouse, dragymouse;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA YANG ANDA MASUKAN TIDAK COCOK");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForgetError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ForgetError().setVisible(true);
            }
        });
    }
